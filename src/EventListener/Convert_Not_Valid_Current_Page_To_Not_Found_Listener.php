...
use Pagerfanta\Exception\Not_Valid_Current_Page_Exception;
...
final class Convert_Not_Valid_Current_Page_To_Not_Found_Listener
{
    public function on_kernel_exception(Exception_Event $event): void
    {
        $throwable = $event->get_throwable();
        if ($throwable instanceof Not_Valid_Current_Page_Exception) {
